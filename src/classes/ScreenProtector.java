...
public class ScreenProtector extends javax.swing.JFrame implements Runnable{
	...
	public void run() {
		...
		for(int i=0; i<5; i++) {
			shapes.add(new Rectangle(colorGenerate(), rand.nextInt(getWidth()-200), rand.nextInt(getHeight()-200), rand.nextInt(190)+10, rand.nextInt(190)+10)); 
			shapes.add(new Square(colorGenerate(), rand.nextInt(getWidth()-200), rand.nextInt(getHeight()-200), rand.nextInt(190)+10)); 
			shapes.add(new Ellipse(colorGenerate(), rand.nextInt(getWidth()-200), rand.nextInt(getHeight()-200), rand.nextInt(190)+10, rand.nextInt(190)+10)); 
			shapes.add(new Circle(colorGenerate(), rand.nextInt(getWidth()-200), rand.nextInt(getHeight()-200), rand.nextInt(190)+10, rand.nextInt(190)+10)); 
		}
		...
		Image logo = new Image("/imges/logo_senai.png", 500, 500, "/sounds/impact.wav", false);
		logo.scale(0.8);
		...
		while(true) {
			...
			logo.changeDirLogo(getWidth(), getHeight());
